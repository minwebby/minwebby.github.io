function apply(effect, objectId) {
	effect.setTarget(document.getElementById(objectId));
	effect.setForever();
	effect.start();
}
...
Aurora.prototype.setTarget = function(target) {
...
Aurora.prototype.setForever = function() {
	this.forever = true;
};

Aurora.prototype.start = function() {
